        ...
        <div className="left-section">
          <div className="inner-content">
            ...
            <p className="subheading">
              Looks like the page you were looking for is no longer here. <br /> <br />
              <Link className="btn btn-download wow fadeInLeft" style={{  textDecoration:"none" }} to="/">Go Back!</Link>
            </p>
          </div>
        </div>
